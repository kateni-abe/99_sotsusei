import{r as i,j as c,a as l}from"./app-80064731.js";import{A as f}from"./AuthenticatedLayout-3817bab7.js";import{Q as x}from"./index-90557d1e.js";import{s as _,B as g}from"./Button-d2d86f32.js";import"./transition-92e5c868.js";const E=_(g)({boxShadow:"none",textTransform:"none",borderRadius:8,fontSize:15,padding:"6px 30px",lineHeight:1.5,backgroundColor:"black",fontFamily:["-apple-system","BlinkMacSystemFont",'"Segoe UI"',"Roboto",'"Helvetica Neue"',"Arial","sans-serif",'"Apple Color Emoji"','"Segoe UI Emoji"','"Segoe UI Symbol"'].join(","),"&:hover":{backgroundColor:"#555555",boxShadow:"none"},"&:active":{boxShadow:"none",backgroundColor:"#333333",borderColor:"#005cbf"},"&:focus":{boxShadow:"0 0 0 0.2rem rgba(0,123,255,.5)"}});function s({auth:t,userDetails:o={}}){const b=Object.keys(o).filter(e=>e.endsWith("_public")&&o[e]),[d,m]=i.useState(!1),[a,p]=i.useState("");b.length>0;let n=`BEGIN:VCARD
VERSION:3.0
